...
var LoginComponent = /** @class */ (function () {
    ...
    LoginComponent.prototype.onLoginClick = function (event) {
        ...
        var body = 'username=' + this.loginViewModel.login + '&password=' + this.loginViewModel.password + '&grant_type=password&scope=openid offline_access';
        this.http.post('/connect/token', body, { headers: this.authService.contentHeaders() })
            ...
            // failed
            _this.errorMessage = "Запрос не был обработан. Что-то нехорошее с сервером.";
        });
    };
