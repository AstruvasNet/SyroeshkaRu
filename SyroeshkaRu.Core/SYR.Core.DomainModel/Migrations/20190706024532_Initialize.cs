        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DateIn = table.Column<int>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SequrityId = table.Column<Guid>(nullable: false),
                    IsDeleted = table.Column<bool>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SequrityProfiles", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    SequrityProfileId = table.Column<Guid>(nullable: false),
                    RoleId = table.Column<string>(nullable: false),
                    Allow = table.Column<bool>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_SequrityRoles", x => new { x.SequrityProfileId, x.RoleId });
                    table.ForeignKey(
                        name: "FK_SequrityRoles_AspNetRoles_RoleId",
                        column: x => x.RoleId,
                        principalTable: "AspNetRoles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SequrityRoles_SequrityProfiles_SequrityProfileId",
                        column: x => x.SequrityProfileId,
                        principalTable: "SequrityProfiles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });

            migrationBuilder.CreateTable(
                name: "StoragesCategories",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_StoragesCategories", x => new { x.StorageId, x.CategoryId });
                    table.ForeignKey(
                        name: "FK_StoragesCategories_Categories_CategoryId",
                        column: x => x.CategoryId,
                        principalTable: "Categories",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_StoragesCategories_Storages_StorageId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SequrityRoles_RoleId",
                table: "SequrityRoles",
                column: "RoleId");

            migrationBuilder.CreateIndex(
                name: "IX_StoragesCategories_CategoryId",
                table: "StoragesCategories",
                column: "CategoryId");
